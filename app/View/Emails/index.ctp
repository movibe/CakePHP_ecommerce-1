<div class="emails index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('attempts'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($email['Email']['from']); ?>&nbsp;</td>
		<td><?php echo h($email['Email']['to']); ?>&nbsp;</td>
		<td><?php echo h($email['Email']['subject']); ?>&nbsp;</td>
		<td><?php echo h($email['Email']['body']); ?>&nbsp;</td>
		<td><?php echo h($email['Email']['headers']); ?>&nbsp;</td>
		<td><?php echo h($email['Email']['is_sent']); ?>&nbsp;</td>
		<td><?php echo h($email['Email']['attempts']); ?>&nbsp;</td>
		<td><?php echo h($email['Email']['created_date']); ?>&nbsp;</td>
		<td class="actions">
