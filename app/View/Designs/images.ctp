...
$(function () {
    ...
    $('#fileupload').fileupload({
        ...
        url: '<?php echo $this->Html->url(array('controller' => 'images', 'action' => 'upload', 'Design', $id));?>',
        maxNumberOfFiles: 1
    });
    ...
    if (window.location.hostname){
        ...
        $.ajax({
            // Uncomment the following to send cross-domain cookies:
            //xhrFields: {withCredentials: true},
            url: '<?php echo $this->Html->url(array('ext' => 'json', 'controller' => 'images', 'action' => 'upload', 'Design', $id));?>',
            dataType: 'json',
