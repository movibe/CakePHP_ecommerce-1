<div class="settings index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('min_goal_amount'); ?></th>
			<th><?php echo $this->Paginator->sort('max_goal_amount'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($setting['Setting']['min_goal_amount']); ?>&nbsp;</td>
		<td><?php echo h($setting['Setting']['max_goal_amount']); ?>&nbsp;</td>
		<td><?php echo h($setting['Setting']['is_active']); ?>&nbsp;</td>
