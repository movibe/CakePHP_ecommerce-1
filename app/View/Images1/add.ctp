...
<div class="row">
	<div class="offset4 span4 text-center">
		<?php echo $this->Html->link('Home', array('action' => 'add'), array('class' => 'btn btn-primary'));?>
	</div>
</div>
...
$(function () {
    ...
    $('#fileupload').fileupload({
        ...
        url: '<?php echo $this->Html->url(array('controller' => 'images', 'action' => 'upload', $itemId));?>'
	    });
    ...
    if (window.location.hostname){
        ...
        $.ajax({
            // Uncomment the following to send cross-domain cookies:
            //xhrFields: {withCredentials: true},
            url: '<?php echo $this->Html->url(array('controller' => 'images', 'action' => 'upload', $itemId . '.json'));?>',
            dataType: 'json',
